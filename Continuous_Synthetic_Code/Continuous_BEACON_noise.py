...
class CustomAcquisitionFunction(AnalyticAcquisitionFunction):
    ...
    def forward(self, X):
        ...
        # We can sample with botorch rsample function
        # batch_shape x N x m
...
if __name__ == '__main__':
    ...
    Consider_noise = True # Consider noise or not
    noise_std = 0.5
    ...
    torch.save(coverage_tensor, '4DNoisyAckley_coverage_list_NS_TS_considernoise_0.5.pt')
    torch.save(cost_tensor, '4DNoisyAckley_cost_list_NS_TS_considernoise_0.5.pt')  
    # torch.save(time_tensor, '4DNoisyAckley_time_list_NS_TS.pt')
