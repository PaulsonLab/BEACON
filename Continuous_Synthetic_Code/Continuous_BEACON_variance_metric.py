...
if __name__ == '__main__':
    ...
    torch.save(coverage_tensor, '4DAckley_variance_list_NS_TS.pt')
    torch.save(cost_tensor, '4DAckley_cost_variance_list_NS_TS.pt')  
