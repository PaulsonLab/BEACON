...
coverage_NS_TS1 = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_TS_1_coverage_list_NS.pt')

cost_BO = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_cost_list_MaxVar.pt')
coverage_BO = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_MaxVar.pt')
...
coverage_RS = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_RS.pt')
...
coverage_GA_NS_novel = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_GA.pt')
...
coverage_DEA = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_DEA.pt')
...
coverage_sobol = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_sobol.pt')
...
coverage_NS_xspace = torch.load('/home/tang.1856/Jonathan/Novelty Search/Continuous_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_NS_x_space.pt')
...
plt.plot(cost_GA_NS_novel_mean[::2], coverage_GA_NS_novel_mean[::2], label='NS-EA', marker='>', markersize=marker_size,linewidth=linewidth  )
plt.plot(cost_DEA_mean[::2], coverage_DEA_mean[::2], label='NS-DEA', marker='D', markersize=marker_size,linewidth=linewidth  )
...
plt.fill_between(cost_DEA_mean, coverage_DEA_mean - coverage_DEA_std, coverage_DEA_mean + coverage_DEA_std,  alpha=0.3)
plt.fill_between(cost_NS_xspace_mean, coverage_NS_xspace_mean - coverage_NS_xspace_std, coverage_NS_xspace_mean + coverage_NS_xspace_std,  alpha=0.3)
plt.fill_between(cost_sobol_mean, coverage_sobol_mean - coverage_sobol_std, coverage_sobol_mean + coverage_sobol_std,  alpha=0.3)
plt.fill_between(cost_RS_mean, coverage_RS_mean - coverage_RS_std, coverage_RS_mean + coverage_RS_std,  alpha=0.3)
...
plt.legend(prop={'weight':'bold','size':text_size-2}, loc=2)
# plt.title(synthetic)
