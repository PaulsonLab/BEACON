...
synthetic = 'MOF'
cost_NS_TS1 = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_TS_1_cost_list_NS.pt')
coverage_NS_TS1 = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_TS_1_coverage_list_NS.pt')

cost_BO = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_cost_list_MaxVar.pt')
coverage_BO = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_MaxVar.pt')

cost_RS = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_cost_list_RS.pt')
coverage_RS = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_RS.pt')


cost_NS_xspace = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_cost_list_NS_xspace.pt')
coverage_NS_xspace = torch.load('/home/tang.1856/Jonathan/Novelty Search/Discrete_MultiOutcome/Results/'+synthetic+'/'+synthetic+'_coverage_list_NS_xspace.pt')
