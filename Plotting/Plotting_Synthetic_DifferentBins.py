...
cost_BO = torch.load(path+synthetic+'/'+synthetic+'_cost_list_MaxVar_'+'bins'+str(bins)+'.pt')
coverage_BO = torch.load(path+synthetic+'/'+synthetic+'_coverage_list_MaxVar_'+'bins'+str(bins)+'.pt')

cost_RS = torch.load(path+synthetic+'/'+synthetic+'_cost_list_RS_'+'bins'+str(bins)+'.pt')
coverage_RS = torch.load(path+synthetic+'/'+synthetic+'_coverage_list_RS_'+'bins'+str(bins)+'.pt')


cost_GA_NS_novel = torch.load(path+synthetic+'/'+synthetic+'_cost_list_GA_'+'bins'+str(bins)+'.pt')
coverage_GA_NS_novel = torch.load(path+synthetic+'/'+synthetic+'_coverage_list_GA_'+'bins'+str(bins)+'.pt')

cost_DEA = torch.load(path+synthetic+'/'+synthetic+'_cost_list_DEA_'+'bins'+str(bins)+'.pt')
coverage_DEA = torch.load(path+synthetic+'/'+synthetic+'_coverage_list_DEA_'+'bins'+str(bins)+'.pt')

cost_sobol = torch.load(path+synthetic+'/'+synthetic+'_cost_list_sobol_'+'bins'+str(bins)+'.pt')
coverage_sobol = torch.load(path+synthetic+'/'+synthetic+'_coverage_list_sobol_'+'bins'+str(bins)+'.pt')

cost_NS_xspace = torch.load(path+synthetic+'/'+synthetic+'_cost_list_NS_x_space_'+'bins'+str(bins)+'.pt')
coverage_NS_xspace = torch.load(path+synthetic+'/'+synthetic+'_coverage_list_NS_x_space_'+'bins'+str(bins)+'.pt')
