...
# Usage
We provide the code scripts for executing BEACON on different problem setting. Each folder corresponds to specific problem setting (continuous/discrete search space and single/multi outcome space).
