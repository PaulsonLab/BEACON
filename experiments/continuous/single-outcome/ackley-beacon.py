#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run the Ackley continuous single-outcome BEACON study.

Inputs: synthetic Ackley function from BoTorch.
Outputs: cost.pt and coverage.pt in results/generated/continuous/single-outcome/ackley-beacon.
