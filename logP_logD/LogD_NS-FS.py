...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 12 15:42:32 2024
...
if __name__ == '__main__':
    ...
    obj_lb = y_original.min() 
    obj_ub = y_original.max() 
    ...
    torch.save(coverage_tensor, 'logD_coverage_list_NS_xspace.pt')
    torch.save(cost_tensor, 'logD_cost_list_NS_xspace.pt')  
