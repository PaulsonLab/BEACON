...
if __name__ == '__main__':
    ...
    torch.save(coverage_tensor, 'logP_coverage_list_NS_SAAS_mean.pt')
    torch.save(uniformity_tensor, 'logP_uniformity_list_NS_SAAS_mean.pt')
    torch.save(cost_tensor, 'logP_cost_list_NS_SAAS_mean.pt')  
