...
class CustomAcquisitionFunction():
    ...
    def __call__(self, X):
        ...
        samples = posterior.rsample(sample_shape=torch.Size([1])).mean(dim=1) # SaasBO
...
if __name__ == '__main__':
    ...
    torch.save(coverage_tensor, 'logP_coverage_list_NS_SAAS.pt')
    torch.save(uniformity_tensor, 'logP_uniformity_list_NS_SAAS.pt')
    torch.save(cost_tensor, 'logP_cost_list_NS_SAAS.pt')  
